...
const Filter = (props) => {
    return(
        <div className="filter">
            <Navbar>
                <Nav>
                    <LinkContainer to="/home/most%20recent">
                        <NavItem className="filter-item" eventKey={5}>Most Recent</NavItem>
                    </LinkContainer>
                    <LinkContainer to="/home/player%20analysis">
                    ...
                    <LinkContainer to="/home/roster%20construction">
                        <NavItem className="filter-item" eventKey={8}>Roster Construction</NavItem>
                    </LinkContainer>
                    <LinkContainer to="/home/trade%20analysis">
